...
#
# My process is to build ROS2 on one RaspberryPi3 then create a TAR file of the /opt/ros3
...
DoSetKeys="yes"
DoSetLocale="yes"
DoFetchBuildTools="yes"
DoFetchNewCMake="no"
DoFetchROS2Sources="yes"
DoFetchROS2Dependencies="yes"
DoBuild="yes"
DoCreateTARFiles="yes"
